...
import { ChevronDown, ShieldCheck, Feather, Boxes, Sparkles } from "lucide-react";
...
export default function Page() {
  ...
  return (
    <div className={`fixed-navbar ${dmSans.variable} ${fontBody.variable} ${fontHeading.variable}`}>
          ...
          <div className="row">
            <div className="col col-xs-12">
              <div className="wpo-breadcumb-wrap">
                <ol>
                  <li>Kategoriler / Tamamlayıcı Mobilyalar / Sehpa</li>
                </ol>
                <h2 className="fade_bottom slow-reveal">Sehpa</h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="cat-split container">
        <div className="split-grid">
          <div className="split-text" style={{ fontFamily: "Poppins" }}>
            <h3 style={{ fontFamily: "Poppins" }}>Merkezde Estetik, Kenarda Pratik</h3>
            <p>
              Orta, yan ve zigon sehpalar; oturma düzenini tamamlayan şık ve fonksiyonel parçalardır.
              Çizilmeye dayanıklı yüzeyler, hafif gövde ve gizli depolama çözümleriyle hem günlük
              kullanımda hem misafir ağırlamada konfor sağlar.
            </p>

            <ul className="bullet">
              <li>Orta/yan/zigon alternatifleri, modüler kombinler</li>
              <li>Hafif gövde, kolay taşınabilir tasarım</li>
              <li>Leke tutmaz, kolay temizlenen kaplamalar</li>
              <li>Çekmeceli veya raflı depolama seçenekleri</li>
            </ul>
      ...
      <section className="container features">
        ...
        <div className="feature-grid" style={{ fontFamily: "Poppins" }}>
          <article className="feature-card">
            ...
            <h4 style={{ fontFamily: "Poppins" }}>Hafif & Taşınabilir</h4>
            <p>İnce profil, kolay yer değiştirme; temizlik ve düzenlemede pratiklik.</p>
          </article>
          ...
          <article className="feature-card">
            ...
            <h4 style={{ fontFamily: "Poppins" }}>Gizli Depolama</h4>
            <p>Çekmece/raf çözümleriyle kumanda, dergi ve aksesuarları düzenleyin.</p>
          </article>
        ...
        <article className="feature-card">
            ...
            <h4 style={{ fontFamily: "Poppins" }}>Dayanıklı Yüzey</h4>
            <p>Çizilmeye ve lekeye dirençli kaplamalar; kolay bakım, uzun ömür.</p>
          </article>
        </div>
      </section>
          ...
          <div className="split-text">
            ...
            <div className="faq">
              <details className="faq-item">
                <summary>
                  Hangi ölçüde orta sehpa seçmeliyim?
                  <ChevronDown className="chev" size={18} />
                </summary>
                <div className="faq-body">
                  Koltuk uzunluğunun ~<b>%60–70</b>’i uzunlukta; koltuk oturumundan ~<b>2–5 cm</b> alçak
                  yükseklikte olması önerilir. Çevresinde en az <b>40–45 cm</b> dolaşım bırakın.
                </div>
              </details>

              <details className="faq-item">
                <summary>
                  Yüzeyde leke/çizik olur mu, bakımı nasıl?
                  <ChevronDown className="chev" size={18} />
                </summary>
                <div className="faq-body">
                  Mat, leke tutmaz kaplamalar günlük kullanımda avantaj sağlar. Sıcak servislerde
                  altlık kullanın; temizlikte nemli mikrofiber bez yeterlidir.
                </div>
              </details>

              <details className="faq-item">
                <summary>
                  Zigon sehpalar sağlam mı?
                  <ChevronDown className="chev" size={18} />
                </summary>
                <div className="faq-body">
                  Metal/ahşap iskelet ve dengeli ayak yapısıyla uzun ömürlüdür. Kullanımda maksimum
                  taşıma değerlerini aşmayın.
                </div>
              </details>
            </div>
          </div>
      ...
      <InstagramGallery tag="ŞıkDetaylar" limit={9} />
      ...
      <style jsx global>{`
        ...
        .cat-hero-img{
          width:100%; height:clamp(220px,42vw,520px); object-fit:cover; border-radius:18px;
          box-shadow:0 12px 36px rgba(0,0,0,.12); display:block;
        ...
        .bullet{ margin:10px 0 18px; padding-left:18px; } .bullet li{ margin:6px 0; }

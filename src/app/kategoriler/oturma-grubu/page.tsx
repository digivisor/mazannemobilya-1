...
export default function Page() {
  ...
  const [mobileCatsOpen] = useState(false);
  ...
  useEffect(() => {
    ...
    const reveal = (el: HTMLElement) => {
      ...
      const SLOW_TITLE_MS = 1100; // H2 gibi öğeler
  ...
  useEffect(() => {
    ...
    const cleanups = [
      ...
      ...heros.map((h) => tilt(h, 5)), // HERO için tilt
    ];
          ...
          <div className="row">
            <div className="col col-xs-12">
              <div className="wpo-breadcumb-wrap">
                <ol>
                  <li>Kategoriler / Oturma Grubu</li>
                </ol>
                <h2 className="fade_bottom slow-reveal">Oturma Grubu</h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="cat-split container">
        <div className="split-grid">
          <div className="split-text" style={{ fontFamily: "Poppins" }}>
            <h3 style={{ fontFamily: "Poppins" }}>Konfor + Dayanıklılık + Estetik</h3>
            <p>
              Oturma odası setlerimiz; yüksek yoğunluklu sünger, leke tutmaz kumaş seçenekleri ve
              modüler yerleşim alternatifleriyle farklı metrekarelere uyum sağlar. Aşağıdaki
              başlıklarda en çok tercih edilen kombinleri özetledik.
            </p>
      ...
      <section className="container features">
        ...
        <div className="feature-grid" style={{ fontFamily: "Poppins" }}>
          <article className="feature-card">
            ...
            <h4 style={{ fontFamily: "Poppins" }}>Sağlam İskelet</h4>
            <p>Fırınlanmış gürgen + metal bağlantılar, uzun ömürlü yapı.</p>
          </article>
          ...
          <article className="feature-card">
            ...
            <h4 style={{ fontFamily: "Poppins" }}>Leke Tutmaz Kumaş</h4>
            <p>Silinebilir, anti-pilling ve nefes alabilen seçenekler.</p>
          </article>
          ...
          <article className="feature-card">
            ...
            <h4 style={{ fontFamily: "Poppins" }}>Ölçüye Uygun</h4>
            <p>Salon ölçüne göre modüler parça ve oturum derinliği.</p>
          </article>
        </div>
      </section>
          ...
          <div className="split-text">
            ...
            <div className="faq">
              <details className="faq-item">
                <summary>
                  Kumaş seçenekleri nelerdir?
                  <ChevronDown className="chev" size={18} />
                </summary>
                <div className="faq-body">
                  Nubuk, keten dokulu, bouclé ve saten dokulu silinebilir kumaşlarımız mevcut.
                  Karteladan renk-doku seçimi yapabilirsiniz.
                </div>
              </details>

              <details className="faq-item">
                <summary>
                  Teslimat süresi kaç gün?
                  <ChevronDown className="chev" size={18} />
                </summary>
                <div className="faq-body">
              ...
              <details className="faq-item">
                <summary>
                  Oturum sertliğini seçebilir miyim?
                  <ChevronDown className="chev" size={18} />
                </summary>
                <div className="faq-body">
                  Evet. Yumuşak, orta ve sert oturum seçenekleri bulunur; showroom’da deneyip karar
                  verebilirsiniz.
                </div>
              </details>
            </div>
...
<InstagramGallery />
      ...
      <style jsx global>{`
        ...
        /* ---------- FAQ: açılış animasyonu + hover highlight ---------- */
        .faq .faq-item {
          border: 1px solid #eee;
          border-radius: 14px;
          padding: 0;

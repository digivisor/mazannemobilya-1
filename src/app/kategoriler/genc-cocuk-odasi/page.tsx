...
import { ChevronDown, ShieldCheck, Ruler, Feather, Palette } from "lucide-react";
...
export default function Page() {
  ...
  // 3D TILT: feature kartları, split görseller ve HERO
  useEffect(() => {
  ...
  return (
    <div className={`fixed-navbar ${dmSans.variable} ${fontBody.variable} ${fontHeading.variable}`}>
          ...
          <div className="row">
            <div className="col col-xs-12">
              <div className="wpo-breadcumb-wrap">
                <ol>
                  <li>Kategoriler / Genç & Çocuk Odası</li>
                </ol>
                <h2 className="fade_bottom slow-reveal">Genç & Çocuk Odası</h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="cat-split container">
        <div className="split-grid">
          <div className="split-text" style={{ fontFamily: "Poppins" }}>
            <h3 style={{ fontFamily: "Poppins" }}>Oyun, Ders, Uyku: Hepsi Bir Arada</h3>
            <p>
              Genç & çocuk odası çözümlerimiz; ders çalışma ergonomisi, güvenli depolama ve uzun
              ömürlü malzemeleri tek tasarımda buluşturur. Modüler parçalar çocuklar büyüdükçe
              yeniden düzenlenebilir; renk temaları ise kişisel zevke göre özelleştirilebilir.
            </p>

            <ul className="bullet">
              <li>Ergonomik çalışma masası + ayarlanabilir sandalye</li>
              <li>Köşe koruma ve devrilme karşıtı (anti-tip) sabitleme seçenekleri</li>
              <li>Ranza, tekli veya ikiz karyola; çekmeceli/bazalı depolama</li>
              <li>Modüler dolap, raf ve oyuncak saklama üniteleri</li>
            </ul>
      ...
      <section className="container features">
        ...
        <div className="feature-grid" style={{ fontFamily: "Poppins" }}>
          <article className="feature-card">
            ...
            <h4 style={{ fontFamily: "Poppins" }}>Güvenli Malzemeler</h4>
            <p>Yuvarlatılmış köşeler, sağlam bağlantılar ve düşük VOC/su bazlı kaplamalar.</p>
          </article>
          ...
          <article className="feature-card">
            ...
            <h4 style={{ fontFamily: "Poppins" }}>Büyüdükçe Uyum</h4>
            <p>Yükseklik ayarlı masa, modüler depolama ve dönüştürülebilir karyola seçenekleri.</p>
          </article>
          ...
          <article className="feature-card">
            ...
            <h4 style={{ fontFamily: "Poppins" }}>Kişisel Tasarım</h4>
            <p>Renk temaları, başlık kumaşı ve kulp seçenekleriyle stilini yarat.</p>
          </article>
        </div>
      </section>
          ...
          <div className="split-text">
            ...
            <div className="faq">
              <details className="faq-item">
                <summary>
                  Çalışma masası ölçüsü ne olmalı?
                  <ChevronDown className="chev" size={18} />
                </summary>
                <div className="faq-body">
                  İlkokul için ~<b>110–120×60 cm</b>, orta/ lise için ~<b>120–140×60–70 cm</b> idealdir.
                  Oturma yüksekliği çocuk boyuna göre ayarlanmalı; ekran göz hizasında olmalıdır.
                </div>
              </details>
              ...
              <details className="faq-item">
                ...
                <div className="faq-body">
                  Devrilme karşıtı duvar sabitleme, yuvarlatılmış köşeler, çekmece stoperleri ve
                  <b> su bazlı</b> kaplama seçenekleri sunuyoruz. Ranza korkuluk yüksekliği yaş
                  grubuna göre planlanır.
                </div>
              </details>

              <details className="faq-item">
                <summary>
                  Oda büyüdükçe mobilyalar uyum sağlar mı?
                  <ChevronDown className="chev" size={18} />
                </summary>
                <div className="faq-body">
                  Modüler parçalar yeniden düzenlenebilir; çalışma masası ve dolap modülleri
                  eklenip çıkarılabilir. Karyolayı çekmeceli/bazalı depolamaya dönüştürebilirsiniz.
                </div>
              </details>
            </div>
          </div>
      ...
      <style jsx global>{`
        ...
        /* Hover/tilt etkisi wrapper üzerinden */
